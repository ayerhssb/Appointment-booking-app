...
const DoctorDetails = () => {
  ...
  console.log(doctor)
  // return 
  // Safeguard: Ensure doctor is defined before destructuring
  if (!doctor) {
    return null; // Return null or a fallback UI while the data is being fetched
  }

  // Destructuring doctor data
  const {
    name,
    qualifications,
    experiences,
              ...
              <div className='flex items-center gap-5 overflow-hidden'>
                <figure className='max-w-[200px] max-h-[200px]'>
                  {!photo ? <img src={photo} className='w-full' alt='' /> :
                    <img src={"https://media.istockphoto.com/id/1785918657/photo/portrait-of-doctor-with-smile-confidence-and-hospital-employee-with-care-support-and-trust.jpg?s=2048x2048&w=is&k=20&c=ez_9KDW6JfJIimxorJt98Y_Ez9QGakDowTDs9JHcHJw="} className='w-full' alt='' />}
                </figure>
                <div>
